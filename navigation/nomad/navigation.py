...
class Navigation:
    ...
    def navigate(self, goal_node):
        ...
        while sub_goal_idx != len(shortest_path):
            ...
            goals = []
            current_idx = self.nomad.get_closest_node(self.obs_images, sub_goal_images)
    ...
    def set_obs_images(self, obs_images):
        print("[*] obs_images set.")
        
        while not self.obs_images.empty():
            self.obs_images.get()
